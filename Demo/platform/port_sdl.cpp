...
public:
	bool Init(App *app);
	AppBackendSDL()	: m_quit_requested(false)
						, m_app(nullptr)
						, m_renderer(nullptr)
						, mainWindow(0)
...
bool
AppBackendSDL::InvokeKey(unsigned int key, SPECIAL_KEY special_key, MODIFIER_KEYS modifierkeys, bool down)
{
...
void
AppBackendSDL::QueueUserEvent(Sint32 code, void * data1, void * data2)
{
...
bool
AppBackendSDL::HandleSDLEvent(SDL_Event & event)
{
	bool handled = true;
	switch (event.type) {
	case SDL_KEYUP:
