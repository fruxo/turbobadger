...
TB_TEST_GROUP(tb_color)
{
	...
	{
		TBColor col;
		col.SetFromString(TBStr("#11223344", 9));
	...
	{
		TBColor col;
		col.SetFromString(TBStr("#112233", 7));
		TB_VERIFY(col.r == 0x11);
		TB_VERIFY(col.g == 0x22);
		TB_VERIFY(col.b == 0x33);
	...
	{
		TBColor col;
		col.SetFromString(TBStr("#1234", 5));
		TB_VERIFY(col.r == 0x11);
		TB_VERIFY(col.g == 0x22);
		TB_VERIFY(col.b == 0x33);
		TB_VERIFY(col.a == 0x44);
