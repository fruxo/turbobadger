...
public:
	...
	virtual bool GetCondition(TBSkinCondition::TARGET target, TBSkinCondition::PROPERTY prop, const TBID &value);
private:
	bool GetCondition(TBWidget *widget, TBSkinCondition::PROPERTY prop, const TBID &value);
	TBWidget *m_widget;
};
